...
export default function CommitList() {
  ...
  function goToOrg(row: CommitListItem, e: React.MouseEvent) {
    e.stopPropagation()
                    ...
                    >
                      ...
                      <td className={TD}>
                        {hasOrg ? (
                          <button
                            type="button"
                            className="text-apple-blue hover:text-apple-blue-hover cursor-pointer bg-transparent border-none p-0 max-w-[150px] truncate inline-block align-bottom focus:outline-none focus-visible:underline"
                            title={orgPath(row)}
