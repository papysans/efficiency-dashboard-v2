...
-- 用途：为 tasks / task_conversations / commits 填充模拟数据
-- 目标数据库：costrict_stat
-- 执行方式：$env:PGPASSWORD='1'; psql -U postgres -d costrict_stat -f seed_data.sql
-- 幂等：使用 INSERT ... ON CONFLICT DO NOTHING，可重复执行
-- ============================================================

-- 切换到 costrict_stat 数据库（initdb.d 脚本按字母序执行，前一个 30-init_db.sql 连接的是 report 库）
\connect costrict_stat

-- === tasks 测试数据 ===
-- 15 个 task，分布在 3 个仓库和 5 个用户中
-- 仓库: repo-costrict-main, repo-kanban-dev, repo-webapp-master（通过 repo_addr+repo_branch 标识）
-- 用户: user-001~005, caller: chat/codereview, ide: vscode/intellij

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-001', 'user-001', '138xxxx0001', 'client-a1', 'vscode', '1.88.0', 'windows', '10.0.19045', 'chat', 'https://github.com/zgsm-ai/costrict.git', 'main', '/home/dev/costrict', 'client-home-dev-costrict', '2026-03-05T09:00:00', '2026-03-05T09:45:00', 2500, 3800, 1.25, 120, 120, '涉及认证模块重构，逻辑较复杂')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-002', 'user-002', '139xxxx0002', 'client-b1', 'intellij', '2025.1', 'linux', '6.5.0', 'codereview', 'https://github.com/zgsm-ai/costrict.git', 'main', '/home/dev/costrict', 'client-home-dev-costrict', '2026-03-06T10:30:00', '2026-03-06T11:15:00', 1800, 2900, 0.95, 85, 72, '代码审查修改量适中')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-003', 'user-003', 'zhangsan-gh', 'client-c1', 'vscode', '1.88.0', 'macos', '14.3', 'chat', 'https://github.com/zgsm-ai/costrict.git', 'main', '/Users/zhangsan/costrict', 'client-users-zhangsan-costrict', '2026-03-08T14:00:00', '2026-03-08T15:30:00', 4200, 6100, 2.10, 230, 144, '新增功能模块，涉及多文件改动')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-004', 'user-004', 'lisi-dev', 'client-d1', 'intellij', '2025.1', 'windows', '11.0.22631', 'codereview', 'https://github.com/zgsm-ai/costrict.git', 'main', 'D:/projects/costrict', 'client-d-projects-costrict', '2026-03-10T08:00:00', '2026-03-10T08:30:00', 900, 1500, 0.48, 45, 24, '小范围代码审查')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-005', 'user-005', 'wangwu2025', 'client-e1', 'vscode', '1.89.0', 'linux', '6.8.0', 'chat', 'https://github.com/zgsm-ai/costrict.git', 'main', '/home/wangwu/costrict', 'client-home-wangwu-costrict', '2026-03-12T16:00:00', '2026-03-12T17:20:00', 3100, 4700, 1.58, 175, 96, '数据库查询优化，涉及索引调整')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-006', 'user-001', '138xxxx0001', 'client-a2', 'vscode', '1.88.0', 'windows', '10.0.19045', 'chat', 'https://github.com/zgsm-ai/kanban.git', 'dev', '/home/dev/kanban', 'client-home-dev-kanban', '2026-03-14T09:30:00', '2026-03-14T10:45:00', 2800, 4200, 1.40, 150, 96, '前端看板组件开发')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-007', 'user-002', '139xxxx0002', 'client-b2', 'vscode', '1.89.0', 'linux', '6.5.0', 'codereview', 'https://github.com/zgsm-ai/kanban.git', 'dev', '/home/dev/kanban', 'client-home-dev-kanban', '2026-03-16T11:00:00', '2026-03-16T11:40:00', 1200, 2000, 0.64, 60, 48, 'API接口审查')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-008', 'user-003', 'zhangsan-gh', 'client-c2', 'intellij', '2025.1', 'macos', '14.3', 'chat', 'https://github.com/zgsm-ai/kanban.git', 'dev', '/Users/zhangsan/kanban', 'client-users-zhangsan-kanban', '2026-03-18T13:00:00', '2026-03-18T14:30:00', 3500, 5200, 1.74, 195, 120, '图表数据聚合逻辑实现')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-009', 'user-004', 'lisi-dev', 'client-d2', 'vscode', '1.88.0', 'windows', '11.0.22631', 'codereview', 'https://github.com/zgsm-ai/kanban.git', 'dev', 'D:/projects/kanban', 'client-d-projects-kanban', '2026-03-20T15:00:00', '2026-03-20T15:25:00', 800, 1300, 0.42, 35, 24, '前端样式微调审查')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-010', 'user-005', 'wangwu2025', 'client-e2', 'intellij', '2025.1', 'linux', '6.8.0', 'chat', 'https://github.com/zgsm-ai/kanban.git', 'dev', '/home/wangwu/kanban', 'client-home-wangwu-kanban', '2026-03-22T10:00:00', '2026-03-22T11:30:00', 3800, 5600, 1.88, 210, 144, '权限控制模块全新实现')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-011', 'user-001', '138xxxx0001', 'client-a3', 'vscode', '1.89.0', 'windows', '10.0.19045', 'chat', 'https://gitee.com/example/webapp.git', 'master', '/home/dev/webapp', 'client-home-dev-webapp', '2026-03-24T08:30:00', '2026-03-24T09:45:00', 2200, 3400, 1.12, 105, 72, '用户注册流程实现')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-012', 'user-002', '139xxxx0002', 'client-b3', 'intellij', '2025.1', 'linux', '6.5.0', 'codereview', 'https://gitee.com/example/webapp.git', 'master', '/home/dev/webapp', 'client-home-dev-webapp', '2026-03-26T14:00:00', '2026-03-26T14:50:00', 1600, 2600, 0.84, 75, 48, '表单验证逻辑审查')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-013', 'user-003', 'zhangsan-gh', 'client-c3', 'vscode', '1.88.0', 'macos', '14.3', 'chat', 'https://gitee.com/example/webapp.git', 'master', '/Users/zhangsan/webapp', 'client-users-zhangsan-webapp', '2026-03-28T10:00:00', '2026-03-28T11:40:00', 3900, 5800, 1.94, 240, 168, '支付模块集成，涉及第三方SDK')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-014', 'user-004', 'lisi-dev', 'client-d3', 'intellij', '2025.1', 'windows', '11.0.22631', 'chat', 'https://gitee.com/example/webapp.git', 'master', 'D:/projects/webapp', 'client-d-projects-webapp', '2026-03-30T09:00:00', '2026-03-30T10:15:00', 2600, 3900, 1.30, 140, 96, '日志系统重构')
ON CONFLICT (task_id) DO NOTHING;

INSERT INTO tasks (task_id, user_id, user_name, client_id, client_ide, client_version, client_os, client_os_version, caller, repo_addr, repo_branch, work_dir, work_dir_id, start_time, end_time, upstream_tokens, downstream_tokens, cost, diff_lines, task_ancient_minutes, task_ancient_minutes_reason)
VALUES
  ('task-015', 'user-005', 'wangwu2025', 'client-e3', 'vscode', '1.89.0', 'linux', '6.8.0', 'codereview', 'https://gitee.com/example/webapp.git', 'master', '/home/wangwu/webapp', 'client-home-wangwu-webapp', '2026-04-01T16:00:00', '2026-04-01T16:35:00', 1100, 1800, 0.58, 50, 24, '工具函数审查，改动较小')
ON CONFLICT (task_id) DO NOTHING;


-- === task_conversations 测试数据 ===
-- 每个 task 3~5 条 conversation，共约 55 条
-- model: GLM-4.7, Kimi-K2.5, MiniMax-M2.1
-- sender: user, assistant

-- task-001 conversations (5条)
INSERT INTO task_conversations (task_id, request_id, sender, prompt_mode, mode, model, start_time, end_time, process_time, process_ttft, upstream_tokens, downstream_tokens, cost, request_content, response_content, user_input, diff, diff_lines, error_code, error_reason)
VALUES
...
VALUES
  ...
  ('commit-003', '2026-03-12T18:00:00', 'https://github.com/zgsm-ai/costrict.git', 'main', 'wangwu', 'wangwu@example.com', 'user-005', 'wangwu2025', 'client-e1', '/home/wangwu/costrict', 180, 120, '数据库查询优化，添加复合索引'),
  ('commit-004', '2026-03-15T11:00:00', 'https://github.com/zgsm-ai/costrict.git', 'main', 'zhangsan', 'zhangsan@example.com', 'user-003', 'zhangsan-gh', 'client-c1', '/Users/zhangsan/costrict', 95, 48, '接口定义补充和文档更新')
...
VALUES
  ...
  ('commit-007', '2026-03-22T12:00:00', 'https://github.com/zgsm-ai/kanban.git', 'dev', 'wangwu', 'wangwu@example.com', 'user-005', 'wangwu2025', 'client-e2', '/home/wangwu/kanban', 220, 144, 'RBAC权限控制完整实现'),
  ('commit-008', '2026-03-25T09:00:00', 'https://github.com/zgsm-ai/kanban.git', 'dev', 'lisi', 'lisi@example.com', 'user-004', 'lisi-dev', 'client-d2', 'D:/projects/kanban', 40, 24, '前端样式微调')
ON CONFLICT (commit_id) DO NOTHING;
...
VALUES
  ...
  ('commit-011', '2026-03-30T11:00:00', 'https://gitee.com/example/webapp.git', 'master', 'lisi', 'lisi@example.com', 'user-004', 'lisi-dev', 'client-d3', 'D:/projects/webapp', 145, 96, '日志系统重构为结构化日志'),
  ('commit-012', '2026-04-01T17:00:00', 'https://gitee.com/example/webapp.git', 'master', 'wangwu', 'wangwu@example.com', 'user-005', 'wangwu2025', 'client-e3', '/home/wangwu/webapp', 55, 24, '工具函数边界条件修复')
ON CONFLICT (commit_id) DO NOTHING;
...
UPDATE tasks SET task_ancient_minutes = 120, task_real_minutes = 22 WHERE task_id = 'task-001';
UPDATE tasks SET task_ancient_minutes = 180, task_real_minutes = 45 WHERE task_id = 'task-003';
UPDATE tasks SET task_ancient_minutes = 90, task_real_minutes = 30 WHERE task_id = 'task-005';
UPDATE tasks SET task_ancient_minutes = 120, task_real_minutes = 35 WHERE task_id = 'task-006';
UPDATE tasks SET task_ancient_minutes = 150, task_real_minutes = 40 WHERE task_id = 'task-008';
...
UPDATE commits SET task_ids = '["task-001","task-003"]'::jsonb, task_ids_silica = '[0.8, 0.6]'::jsonb WHERE commit_id = 'commit-001';

-- commit-003 关联 task-005(silica=0.9)
-- 预期: ai = 30*0.9 = 27
-- 预期: ancient = 90*0.1 = 9
-- 预期: real = 27 + 9 = 36
UPDATE commits SET task_ids = '["task-005"]'::jsonb, task_ids_silica = '[0.9]'::jsonb WHERE commit_id = 'commit-003';
...
UPDATE commits SET task_ids = '["task-006","task-008"]'::jsonb, task_ids_silica = '[0.75, 0.85]'::jsonb WHERE commit_id = 'commit-005';
