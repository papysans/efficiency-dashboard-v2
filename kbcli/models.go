...
type Task struct {
	...
	UserName                    string     `gorm:"type:varchar(255)" json:"user_name"`
	ClientID                    string     `gorm:"type:varchar(255)" json:"client_id"`
	ClientIDE                   string     `gorm:"type:varchar(100)" json:"client_ide"`
	ClientVersion               string     `gorm:"type:varchar(100)" json:"client_version"`
	ClientOS                    string     `gorm:"type:varchar(100)" json:"client_os"`
	...
	TaskRealMinutesRsnManual    *string    `gorm:"type:text" json:"task_real_minutes_reason_manual"`
	...
	TaskAncientMinutesRsnManual *string    `gorm:"type:text" json:"task_ancient_minutes_reason_manual"`
